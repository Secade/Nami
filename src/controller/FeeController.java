...
public class FeeController {
    ...
    @FXML
    private Button train_button, home_button;
    ...
    public void initialize(){
        ...
        train_button.setOnMouseClicked(event -> {
            try {
                FXMLLoader pane = new FXMLLoader(getClass().getResource("/view/DashBoard.fxml"));
                Stage stage = (Stage) train_button.getScene().getWindow();
        ...
        home_button.setOnMouseClicked(event -> {
            try {
